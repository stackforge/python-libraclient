    ...
    def main(self, argv):
        ...
        if not cliutils.isunauthenticated(args.func):
            ...
            if not os_tenant_name and not os_tenant_id:
                raise exceptions.CommandError("You must provide a tenant name "
        ...
        self.cs = VersionedClient(options.libra_api_version, http_client)
        ...
        if not cliutils.isunauthenticated(args.func):
            ...
            if tenant_id and auth_token and management_url:
                ...
                try:
                    ...
                    use_pw = False
                except (exceptions.Unauthorized, exceptions.AuthorizationFailure):
        ...
        try:
            ...
            raise exceptions.CommandError("Invalid OpenStack libra credentials.")
        except exceptions.AuthorizationFailure, e:
            import ipdb
            ipdb.set_trace()
            raise exceptions.CommandError("Unable to authorize user")
